...
String..vtable:         ## virtual function table for String
                        ...
                        ## ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.globl X..vtable
X..vtable:              ## virtual function table for X
                        .quad string7
                        .quad X..new
                        .quad Object.abort
                        .quad Object.copy
...
Main..new:              ## constructor for Main
			...
			movq %rax, %r12
                        ...
                        movq %r14, 16(%r12)
                        ## initialize attributes
                        ## self[3] holds field x (X)
                        movq $0, %r13
                        movq %r13, 24(%r12)
                        ## self[3] x initializer <- new X
                        ## new X
                        pushq %rbp
                        pushq %r12
                        movq $X..new, %r14
...
X..new:                 ## constructor for X
			...
			movq %rax, %r12
                        ...
                        movq %r14, 24(%r13)
                        movq %r13, 24(%r12)
                        ## self[4] blah initializer <- let ... in ...
                        ...
                        movq 0(%rbp), %r13
                        movq %r13, 32(%r12)
                        ## self[5] i initializer <- print(...)
                        ## print(...)
                        pushq %r12
                        pushq %rbp
                        pushq %r12
                        ## obtain vtable for self object of type X
                        movq 16(%r12), %r14
