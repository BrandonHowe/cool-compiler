...
Main.main:              ## method definition
                        ...
                        ## return address handling
                        ## self[3] holds field x (Int)
                        ## fp[0] holds t$4 (2 uses)
                        ## fp[0] holds t$9 (2 uses)
                        ## fp[-1] holds t$1 (2 uses)
                        ## fp[0] holds t$0 (2 uses)
                        ## fp[0] holds t$7 (2 uses)
                        ## fp[0] holds t$3 (1 uses)
                        ## method body begins
.globl Main.main.0
Main.main.0:            ## start
                        jmp Main.main.1
.globl Main.main.1
Main.main.1:            ## while-pred
                        ## t$4 <- x
                        movq 24(%r12), %r13
                        movq %r13, 0(%rbp)
                        ## t$3 <- t$4 < 10
			...
			jne Main.main.3
                        jmp Main.main.2
.globl Main.main.2
Main.main.2:            ## while-join
                        jmp Main.main.4
.globl Main.main.3
Main.main.3:            ## while-body
                        ## t$7 <- x
                        movq 24(%r12), %r13
                        movq %r13, 0(%rbp)
                        ## x <- t$7 + 1
                        ...
                        jmp Main.main.1
.globl Main.main.4
Main.main.4:            ## fcall-pre to type_name
                        ## t$1 <- Default_Object.type_name()
                        pushq %r12
                        pushq %rbp
                        movq $0, %r13
                        cmpq $0, %r13
...
.globl l3
l3:                     pushq %r13
                        ## obtain vtable from object in r1 (type Object)
                        movq 16(%r13), %r14
                        ...
                        jmp Main.main.5
.globl Main.main.5
Main.main.5:            ## fcall-post to type_name
                        ## t$9 <- new IO
                        pushq %rbp
                        pushq %r12
                        movq $IO..new, %r14
                        ...
                        jmp Main.main.6
.globl Main.main.6
Main.main.6:            ## fcall-pre to out_string
                        ## t$0 <- t$9.out_string(t$1,)
                        movq -8(%rbp), %r13
                        movq 24(%r13), %r13
                        movq %r13, %rdi
			call cooloutstr
                        ...
                        jmp Main.main.7
.globl Main.main.7
Main.main.7:            ## fcall-post to out_string
                        ## t$0 <- return
                        movq 0(%rbp), %r13
                        movq %r13, 0(%rbp)
                        jmp Main.main.end
