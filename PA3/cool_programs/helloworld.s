...
A.print:                ## method definition
                        ...
                        pushq %r13
                        pushq %r12
                        ## obtain vtable for self object of type A
                        movq 16(%r12), %r14
...
B.print:                ## method definition
                        ...
                        pushq %r13
                        pushq %r12
                        ## obtain vtable for self object of type B
                        movq 16(%r12), %r14
                        ## look up out_string() at offset 8 in vtable
                        movq 64(%r14), %r14
                        call *%r14
...
l3:                     pushq %r13
                        ...
                        movq $B..vtable, %r14
                        ## look up print() at offset 9 in vtable
                        movq 72(%r14), %r14
                        call *%r14
                        addq $8, %rsp
                        popq %rbp
...
.globl string12
string12:               # "ERROR: 25: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string13
string13:               # "ERROR: 26: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
